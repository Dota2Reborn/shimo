...
public class elementFile {
	...
	@SearchWith(pageName = "mmp_tools", elementName = "add_subtopic", noteName = "插入子主题")
	public WebElement add_subtopic;
	/**
	 * 思维导图各级主题
	 * mmp_topics
	 */

	@SearchWith(pageName = "mmp_topics", elementName = "topic1_1", noteName = "分支主题1")
	public WebElement topic1_1;
}